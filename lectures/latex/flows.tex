...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \draw[-{Latex[length=2mm]}]  (v3) edge node[midway,above right ]{\scriptsize 15/20} (t);
    \draw[-{Latex[length=2mm]}]  (v3) edge node[midway,below right]{\scriptsize 4/9} (v2);
    \draw[-{Latex[length=2mm]}]  (v3) edge (v1);
    \draw[-{Latex[length=2mm]}]  (v1) edge [bend left=10]
    node[midway,right]{\scriptsize{1/4}} (v2);
    \end{tikzpicture}
    \caption{1}
    \label{}
  \end{figure}
  ...
  \begin{tikzpicture}[scale=0.5,every node/.style={scale=0.5,minimum size=22}]
   ...
   \subfigure[Residual]{
    ...
    \begin{tikzpicture}[scale=0.5,every node/.style={scale=0.5,minimum size=22}]
      ...
      \draw[-{Latex[length=2mm]}]  (v2) edge [bend left=10]
       node[midway,left]{\scriptsize{11}} (v1);
      \draw[-{Latex[length=2mm]}]  (v2) edge [bend left=10]
      ...
      \draw[-{Latex[length=2mm]}]  (v1) edge [bend left=10]
      node[midway,right]{\scriptsize{3}} (v2);
      \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item until there is no more augemting paths.
  ...
  \begin{figure}[]
    ...
    \begin{tikzpicture}[scale=0.4,every node/.style={scale=0.5,minimum size=22}]
     ...
     % node[midway,above]{\scriptsize 8} (v3);
      ...
      \draw[-{Latex[length=2mm]}]  (s) edge 
      node[midway,right]{\scriptsize 11/13}(v2);
